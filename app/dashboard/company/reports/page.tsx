...
export default function CompanyReportsPage(){
  ...
  async function fetchData(){
    setLoading(true)
    try {
      const _t = (await supabase.auth.getSession()).data.session?.access_token
  ...
  function exportXLS(){
    const xls = toXLS(rows, ['employee_name','employee_email','course_title','attendance_pct','avg_score','passed'], 'Empresa')
    downloadXLS('reporte_empresa.xls', xls)
  }

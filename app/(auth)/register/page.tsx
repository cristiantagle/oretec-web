  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-12">
      <div className="mx-auto max-w-2xl">
        ...
        <form
          onSubmit={onSubmit}
          className="mt-6 grid gap-4 rounded-2xl border bg-white p-6 shadow-soft"
        >
        ...
        <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-4 text-sm text-slate-600">
          ...
          <p>
            Si eres <span className="font-medium">empresa</span>, podrás gestionar participantes y
            compras en lote. Si eres <span className="font-medium">particular</span>, podrás
            inscribirte en cursos individuales y descargar tus certificados.
          </p>
        </div>
      </div>
    </main>

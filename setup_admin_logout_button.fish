#!/usr/bin/env fish
# Reemplaza app/admin/page.tsx con versión completa que incluye:
# - Botón "Gestionar cursos" (link a /admin/courses)
# - Botón "Cerrar sesión" (POST a /api/admin/auth/logout)
# Compatible con fish (sin here-docs dentro de funciones)

echo "== Actualizando app/admin/page.tsx con botones de Admin =="
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-10">
      <div className="flex items-center justify-between mb-6">
        ...
        {/* Acciones del header: Gestionar cursos + Cerrar sesión */}
...
echo "✅ Listo. Revisa /admin para ver los botones."

...
export default function CourseCard({
    ...
    return (
        ...
        {href ? (
            <Link href={href} target="_blank" rel="noopener noreferrer" className="btn-primary w-full">
            Comprar ahora
            </Link>
        ) : (
            <span className="btn-secondary w-full cursor-not-allowed opacity-60">Próximamente</span>
        )}
        </div>
        </article>
    )

...
function StudentBadgeIcon() {
    return (
        ...
        height="16"
        rx="2"
        className="fill-blue-50 stroke-blue-900/40"
        strokeWidth="1.5"
        />
...
function IconByAccountType({ at }: { at: AccountType | null | undefined }) {
    switch (at) {
        case "company":
            return <CompanyBadgeIcon />;
        case "instructor":
            return <InstructorBadgeIcon />;
        case "admin":
            return <AdminBadgeIcon />;
        case "student":
        default:
            return <StudentBadgeIcon />;
    }
}
    ...
    return (
        ...
        {profile && (
            ...
            {profile.avatar_url ? (
                ...
                height={20}
                unoptimized
                className="h-5 w-5 rounded object-cover ring-1 ring-white/50"
                />
            ) : (
        ...
        {open && (
            ...
            {profile && (
                ...
                {profile.avatar_url ? (
                    ...
                    height={24}
                    unoptimized
                    className="h-6 w-6 rounded object-cover ring-1 ring-blue-200"
                    />
                ) : (
                    <IconByAccountType at={profile.account_type} />
                )}
